...
import database.models.{Trip, Vehicle}
import doobie.implicits._
import doobie._
import DoobieTripRepository._
import database.models.Vehicle.Vehicle

import scala.collection.mutable
import utils.json.CirceJsonCodecs._
...
class DoobieTripRepository[F[_]: Sync](xa: Transactor[F]) extends TripRepository[F]{
